...
namespace TrashSoup.Engine
{
    ...
    public class ResourceManager : Singleton<ResourceManager>
    {
        ...
        public void LoadContent(Game game)
        {
            ...
            AddModel("Models/Weapons/Knife/Knife");    //Wika i Kasia
            ...
            Material awsomeTestMat = new Material("awsomeTestMat", this.Effects[@"Effects\NormalEffect"], Textures[@"Textures\Weapons\Knife\knife_D"]);
            awsomeTestMats.Add(awsomeTestMat);
            awsomeTestMats.Add(awsomeTestMat);
            awsomeTestMat.NormalMap = Textures[@"Textures\Weapons\Knife\knife_N"];
            ...
            awsomeTest.MyTransform = new Transform(awsomeTest, new Vector3(5.0f, 5.0f, 5.0f), new Vector3(0.0f, 0.0f, 1.0f), new Vector3(MathHelper.PiOver2, 0.0f, 0.0f), 0.01f);
            awsomeTest.Components.Add(new CustomModel(awsomeTest, new Model[] { Models["Models/Weapons/Knife/Knife"], null, null }, awsomeTestMats));
        ...
        private void LoadTextures(Game game)
        {
            ...
            //Wika i Kasia
            LoadTexture(@"Textures\Weapons\Knife\knife_D");
            LoadTexture(@"Textures\Weapons\Knife\knife_N");
        }
