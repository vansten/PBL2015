...
namespace TrashSoup.Engine
{
    ...
    public class ResourceManager : Singleton<ResourceManager>
    {
        ...
        public void LoadContent(Game game)
        {
            ...
            AddModel("Models/Enviro/Cars/car2");    //Wika i Kasia
            ...
            Material awsomeTestMat = new Material("awsomeTestMat", this.Effects[@"Effects\NormalEffect"], Textures[@"Textures\Enviro\Cars\car2_D"]);
            awsomeTestMats.Add(awsomeTestMat);
            awsomeTestMats.Add(awsomeTestMat);
            awsomeTestMat.NormalMap = Textures[@"Textures\Enviro\Cars\car2_N"];
            ...
            awsomeTest.Components.Add(new CustomModel(awsomeTest, new Model[] { Models["Models/Enviro/Cars/car2"], null, null }, awsomeTestMats));
        ...
        private void LoadTextures(Game game)
        {
            ...
            //Wika i Kasia
            LoadTexture(@"Textures\Enviro\Cars\car2_D");
            LoadTexture(@"Textures\Enviro\Cars\car2_N");
        }
