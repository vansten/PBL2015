    ...
    public class PlayerController : ObjectComponent, IXmlSerializable
    {
        ...
        protected override void Start()
        {
            ...
            if(MyObject.MyAnimator != null)
            {
                ...
                MyObject.MyAnimator.AvailableStates.Add("AttackFist01", new AnimatorState("AttackFist01", MyObject.MyAnimator.GetAnimationPlayer("Animations/MainCharacter/boxing_2"), AnimatorState.StateType.SINGLE));
